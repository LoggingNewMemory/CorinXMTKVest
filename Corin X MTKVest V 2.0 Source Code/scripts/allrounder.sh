...
for maf0 in /sys/devices/system/cpu
    do
        echo 1750000 > "$maf0/cpu0/cpufreq/scaling_max_freq"
        echo 1750000 > "$maf0/cpu1/cpufreq/scaling_max_freq"
        echo 1750000 > "$maf0/cpu2/cpufreq/scaling_max_freq"
        echo 1750000 > "$maf0/cpu3/cpufreq/scaling_max_freq"
        echo 1750000 > "$maf0/cpu4/cpufreq/scaling_max_freq"
        echo 1750000 > "$maf0/cpu5/cpufreq/scaling_max_freq"
    done
    for mif0 in /sys/devices/system/cpu
    do
        echo 1750000 > "$mif0/cpu0/cpufreq/scaling_min_freq"
        echo 1750000 > "$mif0/cpu1/cpufreq/scaling_min_freq"
        echo 1750000 > "$mif0/cpu2/cpufreq/scaling_min_freq"
        echo 1750000 > "$mif0/cpu3/cpufreq/scaling_min_freq"
        echo 1750000 > "$mif0/cpu4/cpufreq/scaling_min_freq"
        echo 1750000 > "$mif0/cpu5/cpufreq/scaling_min_freq"
    done
    for maf6 in /sys/devices/system/cpu
    do
        echo 1650000 > "$maf6/cpu6/cpufreq/scaling_max_freq"
        echo 1650000 > "$maf6/cpu7/cpufreq/scaling_max_freq"
    done
    for mif6 in /sys/devices/system/cpu
    do
        echo 1650000 > "$mif6/cpu6/cpufreq/scaling_min_freq"
        echo 1650000 > "$mif6/cpu7/cpufreq/scaling_min_freq"
    done
...
echo "schedutil" > /sys/class/devfreq/mtk-dvfsrc-devfreq/governor
echo "schedutil" > /sys/class/devfreq/13000000.mali/governor
