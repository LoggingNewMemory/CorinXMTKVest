...
echo "500000" > /sys/devices/system/cpu/cpu1/cpufreq/scaling_max_freq
echo "500000" > /sys/devices/system/cpu/cpu2/cpufreq/scaling_max_freq
echo "500000" > /sys/devices/system/cpu/cpu3/cpufreq/scaling_max_freq
